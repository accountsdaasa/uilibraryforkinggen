...
Library.SetAudioIsolation = function(self, enabled)
	if enabled then
		...
		for _, v in pairs(game:GetDescendants()) do
			pcall(checkAndMute, v);
		end
		if Library.AudioLoop then
			task.cancel(Library.AudioLoop);
		end
		Library.AudioLoop = task.spawn(function()
			while true do
				task.wait(1);
				if (not Library.Music or not Library.Music.IsPlaying) then
					break;
				end
				for _, obj in pairs(SoundService:GetDescendants()) do
					if (obj:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\191\242\89\60\22", "\26\236\157\44\82\114\44")) and (obj.Name ~= LUAOBFUSACTOR_DECRYPT_STR_0("\18\35\212\72\7\59\198\82\41", "\59\74\78\181")) and (obj.Volume > 0)) then
						Library.SavedVolumes[obj] = obj.Volume;
						obj.Volume = 0;
					end
				end
				for _, obj in pairs(workspace:GetDescendants()) do
					if (obj:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\22\222\79\84\183", "\211\69\177\58\58")) and (obj.Name ~= LUAOBFUSACTOR_DECRYPT_STR_0("\143\232\120\230\196\222\164\236\122", "\171\215\133\25\149\137")) and (obj.Volume > 0)) then
						Library.SavedVolumes[obj] = obj.Volume;
						obj.Volume = 0;
					end
				end
		...
		if ((input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch)) then
			...
			input.Changed:Connect(function()
				if (input.UserInputState == Enum.UserInputState.End) then
					Dragging = false;
					if saveKey then
						Library.Flags[saveKey .. LUAOBFUSACTOR_DECRYPT_STR_0("\222\240\13\201\236\49\240\71", "\34\129\168\82\154\143\80\156")] = object.Position.X.Scale;
						Library.Flags[saveKey .. LUAOBFUSACTOR_DECRYPT_STR_0("\186\138\12\36\78\72\154\128\166", "\233\229\210\83\107\40\46")] = object.Position.X.Offset;
						Library.Flags[saveKey .. LUAOBFUSACTOR_DECRYPT_STR_0("\254\123\13\229\6\192\78\55", "\101\161\34\82\182")] = object.Position.Y.Scale;
						Library.Flags[saveKey .. LUAOBFUSACTOR_DECRYPT_STR_0("\215\52\102\209\221\228\145\43\252", "\78\136\109\57\158\187\130\226")] = object.Position.Y.Offset;
						Library:Save();
					end
				end
			end);
...
Library.ApplyTheme = function(self, themeName)
	local data = BUILTIN_THEMES[LUAOBFUSACTOR_DECRYPT_STR_0("\26\58\255\240\43\51\237", "\145\94\95\153")];
	if data then
		...
		Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\194\242\55\192\92\165\248\195\0\225\70\178\240\200", "\215\157\173\116\181\46")] = LUAOBFUSACTOR_DECRYPT_STR_0("\17\177\141\243\207\57\160", "\186\85\212\235\146");
	end
	...
	for _, obj in pairs(Library.ThemeObjects.BgItems) do
		if obj:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\229\148\31\209\59\228\93\193\149", "\56\162\225\118\158\89\142")) then
...
Library.Window = function(self, options)
	Library.CurrentConfig = options.ConfigName or LUAOBFUSACTOR_DECRYPT_STR_0("\95\10\206\169\43\223\18\15\211\160\44", "\184\60\101\160\207\66");
	if CoreGui:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\26\139\114\187\22\135\114\137\24", "\220\81\226\28")) then
		SendNotification(LUAOBFUSACTOR_DECRYPT_STR_0("\56\220\140\252\223\238", "\167\115\181\226\155\138"), LUAOBFUSACTOR_DECRYPT_STR_0("\195\46\245\89\122\117\223\162\16\242\82\117\120\200\229", "\166\130\66\135\60\27\17"), 5);
		return;
	end
	Library:Load();
	local ScreenGui = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\119\73\220\112\53\74\109\219\124", "\80\36\42\174\21"));
	ScreenGui.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\101\25\57\125\105\21\57\79\103", "\26\46\112\87");
	ScreenGui.Parent = CoreGui;
	ScreenGui.DisplayOrder = 999;
	ScreenGui.ResetOnSpawn = false;
	ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Global;
	local MusicSound = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\138\44\190\122\187", "\212\217\67\203\20\223\223\37"), ScreenGui);
	MusicSound.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\130\128\169\193\151\152\187\219\185", "\178\218\237\200");
	MusicSound.SoundId = CHRISTMAS_MUSIC_ID;
	MusicSound.Volume = 0.5;
	MusicSound.Looped = true;
	MusicSound:Play();
	Library.Music = MusicSound;
	local SnowEmitter = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\144\167\231\221\179", "\176\214\213\134"), ScreenGui);
	SnowEmitter.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\199\163\185\195\141\91\80\224\185\179\198", "\57\148\205\214\180\200\54");
	...
	task.spawn(function()
		local function CreateSnowflake()
			...
			local flake = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\59\240\52\51\115\62\252\55\49\122", "\22\114\157\85\84"), SnowEmitter);
			flake.Image = LUAOBFUSACTOR_DECRYPT_STR_0("\214\201\11\197\78\229\173\208\194\23\158\18\185\254\148\147\66\149\12\174\254\146\157", "\200\164\171\115\164\61\150");
			...
			local tween = TweenService:Create(flake, TweenInfo.new(duration, Enum.EasingStyle.Linear), {[LUAOBFUSACTOR_DECRYPT_STR_0("\142\251\16\76\151\183\251\13", "\227\222\148\99\37")]=targetPos,[LUAOBFUSACTOR_DECRYPT_STR_0("\1\93\70\247\237\58\93\92", "\153\83\50\50\150")]=math.random(0, 360)});
			tween:Play();
	...
	local MainScale = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\39\9\11\127\189\120\23", "\20\114\64\88\28\220"), MainFrame);
	MainScale.Scale = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\14\62\245\161\241\227\190\48\13\215", "\221\81\97\178\212\152\176")] or DEFAULTS.GuiScale;
	...
	local GiftImage = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\231\115\179\4\128\226\127\176\6\137", "\229\174\30\210\99"), MainFrame);
	GiftImage.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\35\224\135\66\202\52\63\15", "\89\123\141\230\49\141\93");
	...
	task.spawn(function()
		while GiftImage.Parent do
			TweenService:Create(GiftImage, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {[LUAOBFUSACTOR_DECRYPT_STR_0("\193\126\226\13\4\67\252\127", "\42\147\17\150\108\112")]=5}):Play();
			task.wait(1.5);
			TweenService:Create(GiftImage, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {[LUAOBFUSACTOR_DECRYPT_STR_0("\61\169\57\126\243\225\0\168", "\136\111\198\77\31\135")]=-5}):Play();
			task.wait(1.5);
		end
	end);
	local InputBlocker = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\54\12\191\66\159\241\3\189\13\7", "\201\98\105\199\54\221\132\119"), MainFrame);
	InputBlocker.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\144\2\147\52\22\23\160\182\15\136\36\16", "\204\217\108\227\65\98\85");
	InputBlocker.Size = UDim2.new(1, 0, 1, 0);
	InputBlocker.BackgroundTransparency = 1;
	InputBlocker.Text = "";
	InputBlocker.Visible = false;
	InputBlocker.ZIndex = 500;
	local TitleBar = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\120\209\244\232\41", "\160\62\163\149\133\76"), MainFrame);
	TitleBar.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\226\169\25\35\198\244\161\31", "\163\182\192\109\79");
	TitleBar.Size = UDim2.new(1, 0, 0, 44);
	TitleBar.BackgroundColor3 = Theme.SidebarBG;
	TitleBar.ZIndex = 2;
	TitleBar.ClipsDescendants = true;
	Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\1\15\35\207\231\58\35\18", "\149\84\70\96\160"), TitleBar).CornerRadius = UDim.new(0, 16);
	local TitleBarHider = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\30\20\12\224\61", "\141\88\102\109"), TitleBar);
	...
	local HiderGrad = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\134\122\237\98\27\57\92\196\189\71", "\161\211\51\170\16\122\93\53"), TitleBarHider);
	...
	local TitleBarGradient = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\206\135\149\58\250\170\187\45\245\186", "\72\155\206\210"), TitleBar);
	...
	local TitleLogo = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\111\119\85\9\54\106\123\86\11\63", "\83\38\26\52\110"), TitleBar);
	...
	TitleLogo.ZIndex = 3;
	local TitleLabel = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\108\18\63\82\116\22\37\67\84", "\38\56\119\71"), TitleBar);
	TitleLabel.Text = LUAOBFUSACTOR_DECRYPT_STR_0("\216\198\118\241\101\113\214\193\24\155\101\110\222\206\107", "\54\147\143\56\182\69");
	...
	local MinBtn = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\226\132\231\93\253\195\149\235\70\209", "\191\182\225\159\41"), TitleBar);
	...
	MinBtn.ZIndex = 3;
	Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\30\59\11\90\153\137\199\57", "\162\75\114\72\53\235\231"), MinBtn).CornerRadius = UDim.new(0, 12);
	...
	local function AnimateButtonColor(button, color)
		TweenService:Create(button, TweenInfo.new(0.2), {[LUAOBFUSACTOR_DECRYPT_STR_0("\174\61\71\233\84\16\131\41\74\230\112\13\128\51\86\177", "\98\236\92\36\130\51")]=color}):Play();
	end
	MinBtn.MouseEnter:Connect(function()
		AnimateButtonColor(MinBtn, Theme.AccentStart);
	end);
	MinBtn.MouseLeave:Connect(function()
		if not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\155\38\57\147\122\133\156\30\141\52\37\128\96\140", "\80\196\121\108\218\37\200\213")] then
			AnimateButtonColor(MinBtn, Theme.ItemBG);
		end
	end);
	local KGui = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\51\112\16\122\78\0\173\21\122", "\234\96\19\98\31\43\110"), CoreGui);
	KGui.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\45\61\71\211\184\125\133\33\10\91", "\235\102\127\50\167\204\18");
	KGui.ResetOnSpawn = false;
	KGui.DisplayOrder = 1000;
	local KBtn = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\121\172\244\36\65\12\69\181\225\44\74", "\78\48\193\149\67\36"), KGui);
	KBtn.Image = KINGHUB_DECAL_ID;
	KBtn.BackgroundTransparency = 1;
	KBtn.Size = UDim2.new(0, 25, 0, 25);
	local KRatio = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\5\55\161\11\81\53\29\148\42\64\36\23\143\59\78\62\13\148\10\64\57\16\148", "\33\80\126\224\120"), KBtn);
	KRatio.AspectRatio = 1;
	if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\211\151\40\251\108\195\155\60\252\99\223\171\2\200\89", "\60\140\200\99\164")] then
		KBtn.Position = UDim2.new(Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\184\203\47\25\146\168\199\59\30\157\180\247\5\42\167", "\194\231\148\100\70")], Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\121\115\234\156\198\231\117\115\249\156\217\206\64\95\196\183", "\168\38\44\161\195\150")], Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\191\195\169\73\0\199\133\41\185\195\177\117\49\228\179", "\118\224\156\226\22\80\136\214")], Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\125\209\114\191\114\193\106\191\123\209\118\134\68\253\92\148", "\224\34\142\57")]);
	else
		KBtn.Position = UDim2.new(0.9, -110, 0.1, 0);
	end
	KBtn.ScaleType = Enum.ScaleType.Fit;
	KBtn.ZIndex = 3;
	MakeDraggable(KBtn, KBtn, LUAOBFUSACTOR_DECRYPT_STR_0("\225\152\238\226\67\222\110", "\110\190\199\165\189\19\145\61"));
	local function SetState(isMinimized)
		Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\229\212\66\193\180\234\243\197\94\197\162\253\255\207", "\167\186\139\23\136\235")] = isMinimized;
		Library:Save();
		...
		local kSize = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\37\138\163\50\41\188\146\8", "\109\122\213\232")] or DEFAULTS.KSize;
		if isMinimized then
			MainFrame.ZIndex = 1;
			TweenService:Create(MainFrame, mainFrameTweenInfo, {[LUAOBFUSACTOR_DECRYPT_STR_0("\222\248\177\57\250\254\173\62", "\80\142\151\194")]=UDim2.new(0.5, 0, 1.5, 0),[LUAOBFUSACTOR_DECRYPT_STR_0("\49\201\99\77\23\207\120\66", "\44\99\166\23")]=-10}):Play();
			task.wait(0.3);
			MainFrame.Visible = false;
			KBtn.Visible = true;
			KBtn.ImageTransparency = 1;
			TweenService:Create(KBtn, kBtnTweenInfo, {[LUAOBFUSACTOR_DECRYPT_STR_0("\85\250\40\49\54\144\110\246\39\37\35\165\110\242\39\53\42", "\196\28\151\73\86\83")]=0,[LUAOBFUSACTOR_DECRYPT_STR_0("\192\10\51\21", "\22\147\99\73\112\226\56\120")]=UDim2.new(0, kSize, 0, kSize)}):Play();
		else
			TweenService:Create(KBtn, kBtnTweenInfo, {[LUAOBFUSACTOR_DECRYPT_STR_0("\145\120\227\242\136\140\103\227\251\158\168\116\240\240\131\187\108", "\237\216\21\130\149")]=1,[LUAOBFUSACTOR_DECRYPT_STR_0("\177\71\69\90", "\62\226\46\63\63\208\169")]=UDim2.new(0, kSize * 0.8, 0, kSize * 0.8)}):Play();
			task.wait(0.3);
			KBtn.Visible = false;
			MainFrame.Visible = true;
			MainFrame.Position = UDim2.new(0.5, 0, 1.5, 0);
			MainFrame.Rotation = -10;
			TweenService:Create(MainFrame, mainFrameTweenInfo, {[LUAOBFUSACTOR_DECRYPT_STR_0("\213\22\70\138\11\4\32\80", "\62\133\121\53\227\127\109\79")]=UDim2.new(0.5, 0, 0.5, 0),[LUAOBFUSACTOR_DECRYPT_STR_0("\34\27\38\244\194\167\173\30", "\194\112\116\82\149\182\206")]=0}):Play();
		end
	end
	...
	UserInputService.InputBegan:Connect(function(input, gameProcessed)
		...
		local bind = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\237\186\232\44\128\174\88\215\174\217\58", "\52\178\229\188\67\231\201")] or DEFAULTS.ToggleKey;
		if (input.KeyCode.Name == bind) then
			local currentlyMinimized = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\30\126\101\45\200\113\10\15\104\125\45\205\121\7", "\67\65\33\48\100\151\60")];
	...
	Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\17\63\143\238\35\254\210\54", "\183\68\118\204\129\81\144"), SidebarContainer).CornerRadius = UDim.new(0, 16);
	local SidebarHider = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\40\191\113\233\14", "\226\110\205\16\132\107"), SidebarContainer);
	...
	local SidebarGradient = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\222\234\199\203\64\239\202\229\215\85", "\33\139\163\128\185"), SidebarContainer);
	...
	local SidebarStroke = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\98\113\55\202\69\87\15\219", "\190\55\56\100"), SidebarContainer);
	...
	local TabBar = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\101\172\46\17\31\239\250\88\168\26\12\18\238\246", "\147\54\207\92\126\115\131"), SidebarContainer);
	...
	local TabListLayout = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\56\24\25\116\30\106\33\48\44\114\24\106", "\30\109\81\85\29\109"), TabBar);
	TabListLayout.FillDirection = Enum.FillDirection.Vertical;
	TabListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center;
	TabListLayout.SortOrder = Enum.SortOrder.LayoutOrder;
	TabListLayout.Padding = UDim.new(0, 8);
	Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\202\88\100\183\50\218\245\241\118", "\156\159\17\52\214\86\190"), TabBar).PaddingTop = UDim.new(0, 10);
	Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\155\198\141\189\170\235\180\178\169", "\220\206\143\221"), TabBar).PaddingBottom = UDim.new(0, 10);
	...
	Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\192\151\41\20\101\246\240\172", "\152\149\222\106\123\23"), PagesContainer).CornerRadius = UDim.new(0, 16);
	...
	WindowAPI.Init = function(self)
		...
		CreditsTab:Label({[LUAOBFUSACTOR_DECRYPT_STR_0("\231\188\55\19", "\103\179\217\79")]=LUAOBFUSACTOR_DECRYPT_STR_0("\105\191\14\220\82\152\174\75\164\92\240\69\133\183\67\184\18", "\195\42\215\124\181\33\236"),[LUAOBFUSACTOR_DECRYPT_STR_0("\44\85\62\57\43", "\152\109\57\87\94\69")]=Enum.TextXAlignment.Center,[LUAOBFUSACTOR_DECRYPT_STR_0("\218\216\6\172\172", "\200\153\183\106\195\222\178\52")]=Theme.Accent1});
		CreditsTab:Spacer(5);
		CreditsTab:CreditBox({[LUAOBFUSACTOR_DECRYPT_STR_0("\28\226\133\56", "\58\82\131\232\93\41")]=LUAOBFUSACTOR_DECRYPT_STR_0("\167\94\195\22\82\45\135\23\227\16\79\41\134\69", "\95\227\55\176\117\61"),[LUAOBFUSACTOR_DECRYPT_STR_0("\52\119\45\64", "\203\120\30\67\43")]=LUAOBFUSACTOR_DECRYPT_STR_0("\249\49\89\255\202\171\106\2\235\208\226\38\66\253\221\191\34\74\160\235\249\1\67\218\232\227\113\105\250", "\185\145\69\45\143")});
		local SettingsTab = WindowAPI:Tab("⚙️");
		SettingsTab:Label({[LUAOBFUSACTOR_DECRYPT_STR_0("\190\26\1\178", "\188\234\127\121\198")]=LUAOBFUSACTOR_DECRYPT_STR_0("\27\58\1\138\43\38\30\130\43\114\54\149\61\60\7", "\227\88\82\115"),[LUAOBFUSACTOR_DECRYPT_STR_0("\98\19\179\160\12", "\19\35\127\218\199\98")]=Enum.TextXAlignment.Center});
		SettingsTab:Toggle({[LUAOBFUSACTOR_DECRYPT_STR_0("\50\250\7\231", "\130\124\155\106")]=LUAOBFUSACTOR_DECRYPT_STR_0("\247\202\245\164\164\228\115\170\219\207\182\130\182\229\117\188\149\131\219\186\183\243\111\255\250\223\254\170\177\229\53", "\223\181\171\150\207\195\150\28"),[LUAOBFUSACTOR_DECRYPT_STR_0("\106\54\226\169", "\105\44\90\131\206")]=LUAOBFUSACTOR_DECRYPT_STR_0("\192\223\138\180\9\45\210\245\161\176\11", "\94\159\128\210\217\104"),[LUAOBFUSACTOR_DECRYPT_STR_0("\116\252\0\190\74\115\237", "\26\48\153\102\223\63\31\153")]=true,[LUAOBFUSACTOR_DECRYPT_STR_0("\33\65\225\255\0\65\238\248", "\147\98\32\141")]=function(val)
		...
		SettingsTab:Label({[LUAOBFUSACTOR_DECRYPT_STR_0("\44\70\251\222", "\43\120\35\131\170\102\54")]=LUAOBFUSACTOR_DECRYPT_STR_0("\96\14\130\187\160\163\196\18\70\164\185\169\191\150\71", "\228\52\102\231\214\197\208"),[LUAOBFUSACTOR_DECRYPT_STR_0("\63\236\124\205\228", "\182\126\128\21\170\138\235\121")]=Enum.TextXAlignment.Center});
		local themeList = {LUAOBFUSACTOR_DECRYPT_STR_0("\175\223\51\231\147\31\36", "\102\235\186\85\134\230\115\80")};
		SettingsTab:Dropdown({[LUAOBFUSACTOR_DECRYPT_STR_0("\121\13\51\90", "\66\55\108\94\63\18\180")]=LUAOBFUSACTOR_DECRYPT_STR_0("\39\136\137\50\36\77\84\185\141\50\42\92\84\197\169\56\36\82\17\137\204", "\57\116\237\229\87\71"),[LUAOBFUSACTOR_DECRYPT_STR_0("\140\189\236\224", "\39\202\209\141\135\23\142")]=LUAOBFUSACTOR_DECRYPT_STR_0("\192\12\42\31\32\234\250\61\29\62\58\253\242\54", "\152\159\83\105\106\82"),[LUAOBFUSACTOR_DECRYPT_STR_0("\173\207\66\230", "\60\225\166\49\146\169")]=themeList,[LUAOBFUSACTOR_DECRYPT_STR_0("\11\27\41\43\20\11\59", "\103\79\126\79\74\97")]=LUAOBFUSACTOR_DECRYPT_STR_0("\158\122\213\114\75\22\174", "\122\218\31\179\19\62"),[LUAOBFUSACTOR_DECRYPT_STR_0("\144\215\193\205\203\160\70\184", "\37\211\182\173\161\169\193")]=function(val)
			Library:ApplyTheme(LUAOBFUSACTOR_DECRYPT_STR_0("\211\63\75\216\61\119\173", "\217\151\90\45\185\72\27"));
		end});
		SettingsTab:Label({[LUAOBFUSACTOR_DECRYPT_STR_0("\247\121\255\6", "\54\163\28\135\114")]=LUAOBFUSACTOR_DECRYPT_STR_0("\11\206\78\150\65\114\104\248\82\142\65\109\59\155\21\174\65\124\35\222\89\203", "\31\72\187\61\226\46"),[LUAOBFUSACTOR_DECRYPT_STR_0("\226\10\74\213\73", "\68\163\102\35\178\39\30")]=Enum.TextXAlignment.Center});
		local colorNames = {};
		for n, _ in pairs(COLOR_PALETTE) do
			table.insert(colorNames, n);
		end
		table.sort(colorNames);
		SettingsTab:Dropdown({[LUAOBFUSACTOR_DECRYPT_STR_0("\144\113\215\194", "\113\222\16\186\167\99\213\227")]=LUAOBFUSACTOR_DECRYPT_STR_0("\26\6\242\229\110\8\254\247\58\27\233\243\110\7\232\182\44\2\244\245\37\11\255\182\42\27\233\255\32\9\187\213\38\28\242\229\58\3\250\229", "\150\78\110\155"),[LUAOBFUSACTOR_DECRYPT_STR_0("\163\201\38\230", "\32\229\165\71\129\196\126\223")]=LUAOBFUSACTOR_DECRYPT_STR_0("\252\182\231\142\141\218\209\186\193\141\132\214\215\216", "\181\163\233\164\225\225"),[LUAOBFUSACTOR_DECRYPT_STR_0("\124\130\45\99", "\23\48\235\94")]=colorNames,[LUAOBFUSACTOR_DECRYPT_STR_0("\88\223\222\92\66\63\198", "\178\28\186\184\61\55\83")]=LUAOBFUSACTOR_DECRYPT_STR_0("\244\216\85\44\254\11", "\149\164\173\39\92\146\110"),[LUAOBFUSACTOR_DECRYPT_STR_0("\208\38\28\19\24\26\240\44", "\123\147\71\112\127\122")]=function(val)
		end});
		SettingsTab:Dropdown({[LUAOBFUSACTOR_DECRYPT_STR_0("\226\204\143\116", "\38\172\173\226\17")]=LUAOBFUSACTOR_DECRYPT_STR_0("\121\25\37\252\13\23\41\238\89\4\62\234\13\24\63\175\79\29\35\236\70\20\40\175\73\4\62\230\67\22\108\204\69\3\37\252\89\28\45\252", "\143\45\113\76"),[LUAOBFUSACTOR_DECRYPT_STR_0("\158\180\29\59", "\92\216\216\124")]=LUAOBFUSACTOR_DECRYPT_STR_0("\100\13\143\79\241\84\32\159\69\241\94\49\184\18", "\157\59\82\204\32"),[LUAOBFUSACTOR_DECRYPT_STR_0("\20\55\240\238", "\209\88\94\131\154\137\138\179")]=colorNames,[LUAOBFUSACTOR_DECRYPT_STR_0("\12\164\194\125\11\47\37", "\66\72\193\164\28\126\67\81")]=LUAOBFUSACTOR_DECRYPT_STR_0("\197\32\189\93", "\22\135\76\200\56\70"),[LUAOBFUSACTOR_DECRYPT_STR_0("\174\49\244\40\95\224\142\59", "\129\237\80\152\68\61")]=function(val)
		end});
		SettingsTab:Spacer(10);
		SettingsTab:Label({[LUAOBFUSACTOR_DECRYPT_STR_0("\101\173\28\231", "\56\49\200\100\147\124\119")]=LUAOBFUSACTOR_DECRYPT_STR_0("\255\39\172\228\201\51", "\144\172\94\223"),[LUAOBFUSACTOR_DECRYPT_STR_0("\5\3\171\64\42", "\39\68\111\194")]=Enum.TextXAlignment.Center});
		SettingsTab:Slider({[LUAOBFUSACTOR_DECRYPT_STR_0("\248\167\234\194", "\215\182\198\135\167\25")]=LUAOBFUSACTOR_DECRYPT_STR_0("\191\76\238\93\142\76\170\106\185\103\170\123\132\83\239", "\40\237\41\138"),[LUAOBFUSACTOR_DECRYPT_STR_0("\225\120\251\255", "\42\167\20\154\152")]=LUAOBFUSACTOR_DECRYPT_STR_0("\117\193\137\125\66\40\80\251", "\65\42\158\194\34\17"),[LUAOBFUSACTOR_DECRYPT_STR_0("\55\46\92", "\142\122\71\50\108\77\141\123")]=80,[LUAOBFUSACTOR_DECRYPT_STR_0("\56\163\231", "\91\117\194\159\120")]=150,[LUAOBFUSACTOR_DECRYPT_STR_0("\62\24\56\25\32\253\48", "\68\122\125\94\120\85\145")]=80,[LUAOBFUSACTOR_DECRYPT_STR_0("\52\29\195\82\202\216\185\28", "\218\119\124\175\62\168\185")]=function(val)
			Library:UpdateKButtonSize();
		end});
		SettingsTab:Slider({[LUAOBFUSACTOR_DECRYPT_STR_0("\139\241\69\193", "\164\197\144\40")]=LUAOBFUSACTOR_DECRYPT_STR_0("\170\254\190\142\207\176\130\243\175\203\238\181\130\252\175", "\214\227\144\202\235\189"),[LUAOBFUSACTOR_DECRYPT_STR_0("\203\169\134\124", "\92\141\197\231\27\112\211\51")]=LUAOBFUSACTOR_DECRYPT_STR_0("\217\192\173\182\216\213\252\139\175\212", "\177\134\159\234\195"),[LUAOBFUSACTOR_DECRYPT_STR_0("\144\226\49", "\169\221\139\95\192")]=0.5,[LUAOBFUSACTOR_DECRYPT_STR_0("\243\138\103", "\70\190\235\31\95\66")]=1.5,[LUAOBFUSACTOR_DECRYPT_STR_0("\158\231\28\231\240\182\246", "\133\218\130\122\134")]=1,[LUAOBFUSACTOR_DECRYPT_STR_0("\31\254\239\200\222\162\59\55", "\88\92\159\131\164\188\195")]=function(val)
			if Library.MainScale then
				Library.MainScale.Scale = val;
			end
		end});
		SettingsTab:Input({[LUAOBFUSACTOR_DECRYPT_STR_0("\174\47\178\78", "\189\224\78\223\43\183\139")]=LUAOBFUSACTOR_DECRYPT_STR_0("\26\243\141\17\205\43\188\161\19\216", "\161\78\156\234\118"),[LUAOBFUSACTOR_DECRYPT_STR_0("\129\187\200\219", "\188\199\215\169")]=LUAOBFUSACTOR_DECRYPT_STR_0("\195\54\107\116\239\251\5\90\80\237\229", "\136\156\105\63\27"),[LUAOBFUSACTOR_DECRYPT_STR_0("\63\137\127\53\14\128\109", "\84\123\236\25")]=DEFAULTS.ToggleKey,[LUAOBFUSACTOR_DECRYPT_STR_0("\192\135\171\20\169\189\255\135\174\18\190", "\213\144\235\202\119\204")]=LUAOBFUSACTOR_DECRYPT_STR_0("\19\10\219\57\59\99\102\38\1\144\100\102", "\45\67\120\190\74\72\67"),[LUAOBFUSACTOR_DECRYPT_STR_0("\3\35\225\169\251\137\237\226", "\137\64\66\141\197\153\232\142")]=function(val)
			local clean = string.upper(string.gsub(val, " ", ""));
			Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\60\239\22\169\143\4\220\39\141\141\26", "\232\99\176\66\198")] = clean;
		end});
		Library:ApplyTheme(LUAOBFUSACTOR_DECRYPT_STR_0("\200\36\46\7\110\129\237", "\76\140\65\72\102\27\237\153"));
