-- ================================================================= --
--     KING UI - FINAL MODERNIZED V18 (Fix Interactions)
-- ================================================================= --
...
function Library:Window(options)
    ...
    function WindowAPI:Tab(name)
        ...
        function Elements:Toggle(options)
            ...
            local SwitchBg = Instance.new("Frame", Frame) -- Changed to Frame (Visual Only)
            ...
            -- [FIX] Invisible Click Area covering the entire switch
            local ClickArea = Instance.new("TextButton", Frame)
            ClickArea.Text = ""
            ClickArea.BackgroundTransparency = 1
            ClickArea.Size = UDim2.new(0, 50, 1, 0) -- Covers the switch area generously
            ClickArea.Position = UDim2.new(1, -50, 0, 0)
            ClickArea.ZIndex = 10 -- Ensure it's on top
        ...
        function Elements:Dropdown(options)
            ...
            MainBtn.ZIndex = 6 -- Higher ZIndex
        ...
        function Elements:Button(options)
            ...
            Btn.ZIndex = 6 -- Higher ZIndex to ensure clickability
            ...
            Btn.MouseButton1Click:Connect(function()
                -- Simplified animation to prevent script lag/hangs
